...
const Input = ({ question, sublabel=null, className, ...props }) => {
  return (
    <div className='border-b py-2 flex flex-col gap-1 my-6'>
        ...
        <input {...props}  placeholder='Мой ответ' id='answer' className={`placeholder:text-[#AFA9D0] outline-none ${className}`}/>
    </div>
  )
}
