      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <Input label={"Тренинги"} onChange={(e) => setTrainings(e.target.value)} value={trainings}/>
            <Input label={"Выпускницы"} onChange={(e) => setGraduates(e.target.value)} value={graduates}/>
            <Input label={"Регионы"} onChange={(e) => setRegions(e.target.value)} value={regions}/>
          </div>
        </div>
        <SaveButton />
      </div>
